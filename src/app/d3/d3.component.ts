...
export class D3Component implements OnInit {
  ...
  ngAfterContentInit() {
    ...
    var curveTypes = [
      {name: 'curveLinear', curve: d3.curveLinear, active: false, lineString: '', clear: false, info: 'Interpolates the points using linear segments.'},
      ...
      {name: 'curveCatmullRom (α=1)', curve: d3.curveCatmullRom.alpha(1), active: true, lineString: '', clear: false, info: 'Similar to curveCardinal (tension=0) but with a parameter α that determines the parameterisation used to interpolate the points. If α=1 the parameterisation is chordal.'},
